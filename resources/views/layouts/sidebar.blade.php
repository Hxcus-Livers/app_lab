            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    ...
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="{{ route('dashboard') }}"><img src="../assets/img/logo-antarika.png" width="40%"></a>
                    </div>
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a class="nav-link" href="{{ route('register') }}"><i class="far fa-user"></i> <span>Buat Akun</span></a>
                        </li>
